...
urlpatterns = patterns('',
    ...
    url(r'^temi/(?P<slug>[-\w]+)/regioni.(?P<ext>(json|html))$', cache_page()(LeafletView.as_view(filter='temi')), name='territori_leaflet_regioni_tema'),
    url(r'^temi/(?P<slug>[-\w]+)/province.(?P<ext>(json|html))$', cache_page()(LeafletView.as_view(filter='temi')), name='territori_leaflet_province_tema'),
    url(r'^nature/(?P<slug>[-\w]+)/regioni.(?P<ext>(json|html))$', cache_page()(LeafletView.as_view(filter='nature')), name='territori_leaflet_regioni_natura'),
    url(r'^nature/(?P<slug>[-\w]+)/province.(?P<ext>(json|html))$', cache_page()(LeafletView.as_view(filter='nature')), name='territori_leaflet_province_natura'),
)