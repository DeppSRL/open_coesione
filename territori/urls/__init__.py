...
urlpatterns = patterns('',
    ...
    url(r'^info/(?P<tipo>[\w]+)/(?P<lat>[-\d\.]+)/(?P<lng>[-\d\.]+)/$',
       cache_page()(InfoView.as_view()), name='territori_info'),
    url(r'^info/temi/(?P<slug>[-\w]+)/(?P<tipo>[\w]+)/(?P<lat>[-\d\.]+)/(?P<lng>[-\d\.]+)/$',
        cache_page()(InfoView.as_view(filter='temi')), name='territori_temi_info'),
    url(r'^info/nature/(?P<slug>[-\w]+)/(?P<tipo>[\w]+)/(?P<lat>[-\d\.]+)/(?P<lng>[-\d\.]+)/$',
        cache_page()(InfoView.as_view(filter='nature')), name='territori_nature_info'),
    url(r'^autocomplete/$',
