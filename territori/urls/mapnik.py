...
urlpatterns = patterns('',
    url(r'^regioni.xml$',
        MapnikRegioniView.as_view(), name='territori_mapnik_regioni'),
    url(r'^province.xml$',
        MapnikProvinceView.as_view(), name='territori_mapnik_province'),
    url(r'^regioni/(?P<cod_reg>[\d]+)/province.xml$',
        MapnikProvinceView.as_view(), name='territori_mapnik_province_regione'),
    url(r'^regioni/(?P<cod_reg>[\d]+)/comuni.xml$',
        MapnikComuniView.as_view(), name='territori_mapnik_comuni_regione'),
    url(r'^province/(?P<cod_prov>[\d]+)/comuni.xml$',
        MapnikComuniView.as_view(), name='territori_mapnik_comuni_provincia'),
