...
from territori import getTilesConfig
...
class ProvinceListView(TemplateView):
    def render_to_response(self, context, **response_kwargs):
        l = Territorio.objects.filter(territorio='P')
...
class RegionListView(TemplateView):
    def render_to_response(self, context, **response_kwargs):
        l = Territorio.objects.filter(territorio='R')
...
class RegionDetailView(TemplateView):
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        l = Territorio.objects.filter(cod_reg=cod_reg, territorio=type)
...
class ProvinceDetailView(TemplateView):
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        l = Territorio.objects.filter(cod_prov=cod_prov, territorio='C')
...
class MunicipalityDetailView(TemplateView):
    def render_to_response(self, context, **response_kwargs):
        ...
        l = Territorio.objects.filter(cod_com=cod_com)
