...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progetto.pagamento'
        db.add_column('mct_progetti_progetto', 'pagamento',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progetto.pagamento'
        db.delete_column('mct_progetti_progetto', 'pagamento')
