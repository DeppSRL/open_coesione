...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progetto.data_inizio_prevista'
        db.add_column('mct_progetti_progetto', 'data_inizio_prevista',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Progetto.data_fine_prevista'
        db.add_column('mct_progetti_progetto', 'data_fine_prevista',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Progetto.data_inizio_effettiva'
        db.add_column('mct_progetti_progetto', 'data_inizio_effettiva',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Progetto.data_fine_effettiva'
        db.add_column('mct_progetti_progetto', 'data_fine_effettiva',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progetto.data_inizio_prevista'
        db.delete_column('mct_progetti_progetto', 'data_inizio_prevista')

        # Deleting field 'Progetto.data_fine_prevista'
        db.delete_column('mct_progetti_progetto', 'data_fine_prevista')

        # Deleting field 'Progetto.data_inizio_effettiva'
        db.delete_column('mct_progetti_progetto', 'data_inizio_effettiva')

        # Deleting field 'Progetto.data_fine_effettiva'
        db.delete_column('mct_progetti_progetto', 'data_fine_effettiva')
