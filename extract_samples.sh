...
export DATE=20120630 # date used as suffix in csv filenames
export N=1000 # sample size
...
head -n 1 storicizzazione_$DATE.csv > storicizzazione_sorted.csv
tail -n +2 storicizzazione_$DATE.csv | sort >> storicizzazione_sorted.csv
...
head -n 1 storicizzazione_$DATE.csv > storicizzazione_sample.csv
...
django-admin.py extractsamplesrelated --sample=progetti_sample.csv --type=pay storicizzazione_sorted.csv >> $DATA_ROOT/storicizzazione_sample.csv
