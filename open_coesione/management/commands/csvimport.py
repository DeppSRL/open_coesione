...
class Command(BaseCommand):
    ...
    #         soggetto = None
    #         denominazione = re.sub('\s{2,}', u' ', r['OC_DENOMINAZIONE_SOGG']).strip()
    #         codice_fiscale = r['OC_CODICE_FISCALE_SOGG'].strip()
    #         try:
    #
    ...
    #         if 'OC_TERRITORIO_PROG' in r.keys():
    #             tipo_territorio = r['OC_TERRITORIO_PROG']
    ...
    #         dps_flag_cap = r['OC_FLAG_CAP_PROG'] if 'OC_FLAG_CAP_PROG' in r.keys() and r['OC_FLAG_CAP_PROG'] else 0
    #
    #         # codice locale progetto (ID del record)
    #         try:
    ...
    #                     codice=r['OC_CODICE_PROGRAMMA'],
    #                     tipo_classificazione=ProgrammaAsseObiettivo.TIPO.programma,
    #                     defaults={
    #                         'descrizione':r['OC_DESCRIZIONE_PROGRAMMA']
    #                     }
    #                 )
    #                 if created:
    ...
    #                     codice="%s/%s" % (r['OC_CODICE_PROGRAMMA'], r['PO_CODICE_ASSE']),
    ...
    #                     codice="%s/%s/%s" % (r['OC_CODICE_PROGRAMMA'], r['PO_CODICE_ASSE'], r['PO_COD_OBIETTIVO_OPERATIVO']),
    ...
    #                     codice="%s/%s" % (r['OC_CODICE_PROGRAMMA'], r['COD_LINEA']),
    ...
    #                     codice="%s/%s/%s" % (r['OC_CODICE_PROGRAMMA'], r['COD_LINEA'], r['COD_AZIONE']),
    ...
    #                 descrizione=r['OC_TEMA_SINTETICO'],
    ...
    #             self.logger.error("While reading tema sintetico %s in %s. %s" % (r['OC_TEMA_SINTETICO'], codice_locale, e))
    #             continue
    #
    #         try:
    ...
    #         # fonte
    #         try:
    #             if 'FSC' in r['OC_COD_FONTE']:
    #                 tipo_fonte = Fonte.TIPO.fsc
    #             elif 'FS' in r['OC_COD_FONTE']:
    #                 tipo_fonte = Fonte.TIPO.fs
    #             elif r['OC_COD_FONTE'] == 'PAC':
    #                 tipo_fonte = Fonte.TIPO.pac
    #             else:
    #                 tipo_fonte = None
    #
    #             fonte, created = Fonte.objects.get_or_create(
    #                 codice="%s" % (r['OC_COD_FONTE']),
    #                 defaults={
    #                     'descrizione': r['OC_DESCR_FONTE'],
    ...
    #                          (r['OC_COD_FONTE'], codice_locale, e))
    #             continue
    #
    ...
    #             values = {}
    #
    #             values['titolo_progetto'] = r['OC_TITOLO_PROGETTO']
    ...
    #             values['fin_totale_pubblico_netto'] = self._get_value(r, 'OC_FINANZ_TOT_PUB_NETTO', 'decimal')
    ...
    #             values['pagamento_fsc'] = self._get_value(r, 'OC_TOT_PAGAMENTI_FSC', 'decimal')
    #
    #             values['costo_ammesso'] = self._get_value(r, 'COSTO_RENDICONTABILE_UE', 'decimal')
    #             values['pagamento_ammesso'] = self._get_value(r, 'OC_TOT_PAGAMENTI_RENDICONTAB_UE', 'decimal')
    #
    #             # date
    #             values['data_inizio_prevista'] = self._get_value(r, 'OC_DATA_INIZIO_PREVISTA', 'date')
    #             values['data_fine_prevista'] = self._get_value(r, 'OC_DATA_FINE_PREVISTA', 'date')
    #             values['data_inizio_effettiva'] = self._get_value(r, 'OC_DATA_INIZIO_EFFETTIVA', 'date')
    #             values['data_fine_effettiva'] = self._get_value(r, 'OC_DATA_FINE_EFFETTIVA', 'date')
    #
    #             # data ultimo aggiornamento progetto
    #             values['data_aggiornamento'] = self._get_value(r, 'DATA_AGGIORNAMENTO', 'date')
    #
    #             values['dps_flag_presenza_date'] = r['OC_FLAG_PRESENZA_DATE']
    #             values['dps_flag_date_previste'] = r['OC_FLAG_COERENZA_DATE_PREV']
    #             values['dps_flag_date_effettive'] = r['OC_FLAG_COERENZA_DATE_EFF']
    #             values['dps_flag_cup'] = r['OC_FLAG_CUP']
    #             values['dps_flag_pac'] = r['OC_FLAG_PAC']
    ...
    #
    #         # tema
    #         dps_tema = self._normalizza_tema(r['OC_TEMA_SINTETICO'])
    #
    ...
    #
    #         except ObjectDoesNotExist as e:
    #             self.logger.error(u"While reading tema sintetico %s in %s. %s" % (r['OC_TEMA_SINTETICO'], codice_locale, e))
    #             continue
    #
    #         try:
    #             created = False
