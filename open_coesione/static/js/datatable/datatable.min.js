...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primo",sLast:"Ultimo",sNext:"Successivo",sPrevious:"Precedente"},sEmptyTable:"Nessun dato disponibile",sInfo:"da _START_ a _END_ di _TOTAL_ righe",sInfoEmpty:"Nessun Dato",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostra _MENU_ righe",sLoadingRecords:"Caricamento...",sProcessing:"Caricamento...",sSearch:"Cerca:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nessun dato trovato"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
