...
class OpendataView(TemplateView):
    def get_context_data(self, **kwargs):
        ...
        context['approfondimenti_1_1_file'] = self.get_complete_localfile('approfondimenti/progetti_focus_scuole_20170430.zip')
        ...
        context['approfondimenti_2_1_file'] = self.get_complete_localfile('approfondimenti/progetti_focus_beni_confiscati_20170430.csv')
        ...
        context['approfondimenti_3_1_file'] = self.get_complete_localfile('approfondimenti/progetti_focus_turismo_20170430.zip')
