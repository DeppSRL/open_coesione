...
urlpatterns = patterns('',
    ...
    url(r'^speciale-scuole/$', TemplateView.as_view(template_name='open_coesione/focus_scuole.html'), {'MIUR_EXT_API_URL': settings.MIUR_EXT_API_URL}, name='speciale-scuole'),
    url(r'^focus-scuole/$', TemplateView.as_view(template_name='open_coesione/focus_scuole.html'), {'MIUR_EXT_API_URL': settings.MIUR_EXT_API_URL}, name='speciale-scuole'),
